...
HD_PWD='/home/hannes/Entwicklung/synthesizer/FPGA/audio_station/audio_station.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_station_overview_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_station_overview_wrapper.tcl
