...
src/%.o: ../src/%.c
	...
	arm-none-eabi-gcc -Wall -O0 -g3 -c -fmessage-length=0 -MT"$@" -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -I/home/hannes/Entwicklung/synthesizer/vitis_rtos_irq/audio_station/export/audio_station/sw/audio_station/standalone_domain/bspinclude/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
